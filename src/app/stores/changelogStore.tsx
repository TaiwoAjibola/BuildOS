...
const SEED_ENTRIES: ChangelogEntry[] = [
  ...
  { id: "seed-14", timestamp: "2026-07-21T14:00:00.000Z", module: "Admin", action: "CHANGELOG", entityType: "System", entityId: "UPD-014", summary: "14. Employee lifecycle: Restructured employee creation flow — HR now creates complete employee records (General/Contact/Payment details), then Admin syncs them to user accounts with role-based permissions. Admin Users page shows sync status (Synced/Unsynced). Updated documentation to reflect two-step HR→Admin flow.", performedBy: "System" },
];
