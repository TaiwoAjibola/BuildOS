                  ...
                  <tr className="bg-amber-50/50">
                    <td className="px-4 py-3">
                      <input value={addFormData.module} onChange={e => setAddFormData({ ...addFormData, module: e.target.value })}
                        placeholder="e.g. ProcurementContract" className="w-full px-2 py-1 text-xs border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-indigo-500" />
                      <p className="text-[10px] text-gray-400 mt-0.5">Must start with "Procurement"</p>
                    </td>
                    <td className="px-4 py-3">
