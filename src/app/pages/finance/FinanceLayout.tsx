...
import {
  ...
  Zap, GitBranch, CalendarCheck, RefreshCw, ScrollText, ShoppingCart,
} from "lucide-react";
...
const sidebarSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Purchase Orders",   href: "/apps/finance/purchase-orders",   icon: <ShoppingCart className="w-4 h-4" />, end: true },
